...
export function About() {
  ...
  const flow = [
    ...
    { t: "企業を知る / 企業に見つけてもらう", d: "自分で企業を探すことも、プロフィールを見た企業から興味を伝えてもらうこともできます。" },
      ...
      <div className="wrap wrap-narrow">
        ...
        <div className="block">
          ...
          <ul style={{ display: "grid", gap: 12, marginTop: 8 }}>
            {[
              "競技経験も含めて、あなたを伝えるプロフィールを作る",
              "競技経験を評価する企業を、業界・職種・勤務地で絞り込んで探す",
              "気になる企業についてキャリアアドバイザーに詳しく聞く",
              "あなたに興味を持った企業がわかる（公開はオフにできます）",
              "キャリアアドバイザーに無料で相談する",
              "就活フットサルなどのイベントに参加する",
            ].map((t) => (
    ...
    <div className="page">
      <div className="wrap wrap-narrow doc">
        ...
        <p>
          ...
          利用者は、プロフィールの公開設定により、企業が閲覧できる状態にするかどうかを選択できます。
          企業から利用者へ直接メッセージが送られることはありません。
        </p>
    ...
    <div className="page">
      <div className="wrap wrap-narrow doc">
        ...
        <ul>
          ...
          <li>掲載企業へのプロフィール情報の提供（公開を許可している場合）</li>
        ...
        <p>
          ...
          個人情報を第三者に提供しません。
          ただし、利用者がキャリアアドバイザーを通じて企業紹介を受けることに同意した場合、
          当該企業へプロフィール情報を提供します。
        </p>
...
export function ForCompanies() {
  ...
  const features = [
    ...
    {
      t: "学生に知ってもらえる",
      d: "貴社のページに「スポーツ経験者を評価するポイント」を掲載できます。何を見ているかを先に伝えることで、学生の理解が深まります。",
    },
    {
      t: "気になる学生に興味を伝えられる",
      d: "競技歴や希望条件から学生を探し、気になる学生にだけ興味を伝えられます。月間の上限があるため、一人ひとり選んでご利用いただく設計です。",
    },
    {
      t: "就活フットサルに参加できる",
      ...
      <div className="wrap wrap-narrow">
        ...
        <div className="block">
          ...
          <p>
            ...
            将来的に学生データベースの検索、「興味を伝える」の利用枠、イベント参加などを有料機能として整備していく方針ですが、
