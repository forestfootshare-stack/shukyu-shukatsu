              ...
              <div className="switch-row">
                <div>
                  ...
                  <p className="tiny" style={{ marginTop: 3 }}>
                    オンにすると、プロフィールを見た企業から直接メッセージが届きます。いつでも変更できます。
                  </p>
                </div>
                <button type="button" className="switch" role="switch" aria-checked={p.scoutOn}
                  aria-label="スカウトを受け取る" onClick={() => set("scoutOn", !p.scoutOn)} />
              </div>
            </>
          )}
        </div>
